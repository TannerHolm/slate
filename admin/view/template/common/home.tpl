  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <div class="latest">
        ...
        <div style="margin-top: 20px" class="dashboard-heading">OpenCart Products</div>
        <div class="dashboard-content">
          <?php foreach ($ads as $ad) { ?>
          <div style="display: inline-block; margin-right: 20px">
            <p><a target="_blank" href="<?php echo $ad->url; ?>"><?php echo $ad->product; ?></a></p>
            <a target="_blank" href="<?php echo $ad->url; ?>"><img src="<?php echo $ad->thumb; ?>" /></a>
          </div>
          <?php } ?>
        </div>
      </div>
