    ...
    <div class="right">
      <div>
        <table class="description">
          <?php if ($manufacturer) { ?>
          <tr>
            <td><?php echo $text_manufacturer; ?></td><td><a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></td>  
          </tr>
          <?php } ?>
          <tr>
          ...
          <tr>
            <td colspan="2"><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /></td>
          </tr>
        </table>
      </div>
      <?php if ($price) { ?>
